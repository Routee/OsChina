...
//		mHeaderLayout.setVisibility(mMode==Mode.PULL_FROM_END?View.INVISIBLE:View.VISIBLE);
//		mFooterLayout.setVisibility(mMode==Mode.PULL_FROM_START?View.INVISIBLE:View.VISIBLE);
