...
public abstract class SelectPage2 extends FrameLayout {

    private View mLoadingView;
    private View mErrorView;
    private View mSuccessView;

    public SelectPage2(Context context) {
        this(context, null);
    }

    public SelectPage2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelectPage2(Context context, AttributeSet attrs, int defStyleAttr) {
